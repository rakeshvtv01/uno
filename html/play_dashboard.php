...
//alert(""+login_org);
/*
var n1=document.getElementById("whose_turn").id;
var n2=document.getElementById("login_id").id;

if(n1==n2){
	//document.getElementById("disp").value="ITS YOUR TURN";
	alert("");
}
*/
					...
					<header class="major special">
						...
						<div class="container 75%">
							<div class="row uniform 50%">
                                ...
                                <input type="text" id="disp" style=" color:#900; font-size:18px; font-style:normal; font-weight:bold">
